...
from util import WarpSampler, data_partition, evaluate, evaluate_valid
...
if __name__ == "__main__":
    ...
    if args.inference_only:
        ...
        print("test NDCG:", t_test[0])
        print("test HR:", t_test[1])
        f.write("NDCG: " + str(t_test[0]) + "\n")
        f.write("HR: " + str(t_test[1]) + "\n")
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            print("valid NDCG:", t_valid[0])
            print("valid HR:", t_valid[1])
            print("test NDCG:", t_test[0])
            print("test HR:", t_test[1])
